...
{
	d_printf("%s rpc audit list                       View configured Auditing policies\n",
		 NET_PROGRAM_NAME);
	d_printf("%s rpc audit enable                     Enable Auditing\n",
		 NET_PROGRAM_NAME);
	d_printf("%s rpc audit disable                    Disable Auditing\n",
		 NET_PROGRAM_NAME);
	d_printf("%s rpc audit get <category>             View configured Auditing policy setting\n",
		 NET_PROGRAM_NAME);
	d_printf("%s rpc audit set <category> <policy>    Set Auditing policies\n\n",
		 NET_PROGRAM_NAME);
