...
#define MOUNT_CIFS_VERSION_MINOR "11"
  ...
  #include "include/version.h"
   ...
   #define MOUNT_CIFS_VENDOR_SUFFIX "-"LIKEWISE_VERSION_OFFICIAL_STRING"-"SAMBA_VERSION_VENDOR_SUFFIX
  #else
   #define MOUNT_CIFS_VENDOR_SUFFIX "-"LIKEWISE_VERSION_OFFICIAL_STRING
  #endif /* LIKEWISE_OFFICIAL_STRING and SAMBA_VERSION_VENDOR_SUFFIX */
 #else
