...
#define UNMOUNT_CIFS_VERSION_MINOR "5"
  ...
  #include "include/version.h"
   ...
   #define UNMOUNT_CIFS_VENDOR_SUFFIX "-"LIKEWISE_VERSION_OFFICIAL_STRING"-"SAMBA_VERSION_VENDOR_SUFFIX
  #else
   #define UNMOUNT_CIFS_VENDOR_SUFFIX "-"LIKEWISE_VERSION_OFFICIAL_STRING
  #endif /* LIKEWISE_VERSION_OFFICIAL_STRING and SAMBA_VERSION_VENDOR_SUFFIX */
 #else
