...
NSS_STATUS _nss_lwidentity_getpwuid_r(uid_t, struct passwd*, char* buffer,
				   size_t buflen, int* errnop);
...
NSS_STATUS _nss_lwidentity_getgrent_r(struct group* result, char* buffer,
				   size_t buflen, int* errnop);
NSS_STATUS _nss_lwidentity_getgrnam_r(const char *name,
				   struct group *result, char *buffer,
				   size_t buflen, int *errnop);
NSS_STATUS _nss_lwidentity_getgrgid_r(gid_t gid,
				   struct group *result, char *buffer,
				   size_t buflen, int *errnop);
