...
NSS_STATUS
_nss_lwidentity_getpwent_r(struct passwd *result, char *buffer, 
			size_t buflen, int *errnop)
{
	NSS_STATUS ret;
...
NSS_STATUS
_nss_lwidentity_getpwuid_r(uid_t uid, struct passwd *result, char *buffer,
			size_t buflen, int *errnop)
{
	NSS_STATUS ret;
...
NSS_STATUS
_nss_lwidentity_getpwnam_r(const char *name, struct passwd *result, char *buffer,
			size_t buflen, int *errnop)
{
	NSS_STATUS ret;
	static struct winbindd_response response;
...
NSS_STATUS
_nss_lwidentity_getgrent_r(struct group *result,
			char *buffer, size_t buflen, int *errnop)
{
...
NSS_STATUS
_nss_lwidentity_getgrlst_r(struct group *result,
			char *buffer, size_t buflen, int *errnop)
{
...
NSS_STATUS
_nss_lwidentity_getgrnam_r(const char *name,
...
NSS_STATUS
_nss_lwidentity_getgrgid_r(gid_t gid,
			struct group *result, char *buffer,
			size_t buflen, int *errnop)
{
	NSS_STATUS ret;
...
NSS_STATUS
_nss_lwidentity_getusersids(const char *user_sid, char **group_sids,
			 int *num_groups,
...
NSS_STATUS
_nss_lwidentity_nametosid(const char *name, char **sid, char *buffer,
		       size_t buflen, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
...
NSS_STATUS
_nss_lwidentity_sidtoname(const char *sid, char **name, char *buffer,
		       size_t buflen, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
...
/* map a sid to a uid */
NSS_STATUS
_nss_lwidentity_sidtouid(const char *sid, uid_t *uid, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
	struct winbindd_request request;
...
/* map a sid to a gid */
NSS_STATUS
_nss_lwidentity_sidtogid(const char *sid, gid_t *gid, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
	struct winbindd_request request;
...
NSS_STATUS
_nss_lwidentity_uidtosid(uid_t uid, char **sid, char *buffer,
		      size_t buflen, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
...
NSS_STATUS
_nss_lwidentity_gidtosid(gid_t gid, char **sid, char *buffer,
		      size_t buflen, int *errnop)
{
	NSS_STATUS ret;
	struct winbindd_response response;
