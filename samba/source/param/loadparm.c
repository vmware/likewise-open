...
static struct parm_struct parm_table[] = {
	...
	{"idmap expire time", P_INTEGER, P_GLOBAL, &Globals.iIdmapCacheTime, NULL, NULL, FLAG_HIDE}, 
	{"idmap negative cache time", P_INTEGER, P_GLOBAL, &Globals.iIdmapNegativeCacheTime, NULL, NULL, FLAG_ADVANCED}, 
	{"idmap negative time", P_INTEGER, P_GLOBAL, &Globals.iIdmapNegativeCacheTime, NULL, NULL, FLAG_HIDE}, 
	...
	{"policy file", P_STRING, P_GLOBAL, &Globals.szPolicyFile, NULL, NULL, FLAG_ADVANCED},
	{"policy refresh interval", P_INTEGER, P_GLOBAL, &Globals.iPolicyRefreshInterval, NULL, NULL, FLAG_ADVANCED},
...
/* Disable the default at least */
#if 0 && defined(HAVE_NL_LANGINFO) && defined(CODESET)
	...
	if (asprintf(&s, "Samba %s", LIKEWISE_VERSION_STRING) < 0) {
...
*/
	...
	Globals.iPolicyRefreshInterval = 300; /* 5 minutes by default */
...
FN_GLOBAL_STRING(lp_policy_file, &Globals.szPolicyFile)
FN_GLOBAL_INTEGER(lp_policy_refresh_interval, &Globals.iPolicyRefreshInterval)
