...
#ifndef __PROXY_CREDS_H__
#define __PROXY_CREDS_H__

#include <ctstatus.h>
#include <sys/types.h>

struct _PROXY_KRB5_CRED_DATA;
typedef struct _PROXY_KRB5_CRED_DATA *PROXY_KRB5_CRED_HANDLE;
