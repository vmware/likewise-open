    ...
    CENTERROR CTArrayConstruct(DynamicArray * array, size_t itemSize) 
{
				 ...
				 CTAllocateMemory(array->capacity * itemSize,
			  ...
			  size_t capacity) 
{
	    ...
	    /* Resize the array */ 
	    ceError =
	    CTReallocMemory(array->data, &array->data, capacity * itemSize);
			  ...
			  void *data, size_t dataLen)
{
		    ...
		    /* Resize the array */ 
		    ceError =
		    CTSetCapacity(array, itemSize,
				  array->capacity + dataLen + array->capacity);
	...
	memcpy((char *)array->data + insertPos * itemSize, data,
		dataLen * itemSize);
