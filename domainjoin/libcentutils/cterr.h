...
/*
 * Centeris error code definitions.
 *
 ...
 *         0x00000000 - 0x0004FFFF = Centeris System error range
 *         0x00050000 - 0x0005FFFF = Centeris Group Policy error range
 *         0x00060000 - 0x000FFFFF = Reserved for future Centeris components
 */
...
#define CENTERROR_COMPONENT_SYSTEM     0x000	/* Centeris Group Policy Agent (Centeris-GPAgent) */
#define CENTERROR_COMPONENT_GP         0x005	/* Centeris Group Policy Agent (Centeris-GPAgent) */
#define CENTERROR_COMPONENT_REGISTRY   0x007	/* Centeris Elektra */
#define CENTERROR_COMPONENT_DOMAINJOIN 0x008	/* Centeris Domainjoin */

/*
 * #define CENTERROR_COMPONENT_Other  0x006 // Example: Other Centeris Component
 */

/*
 * Centeris system error macros
 */
