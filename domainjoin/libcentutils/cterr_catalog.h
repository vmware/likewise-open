...
CENTERROR_CATALOG(CENTERROR_DOMAIN_JOIN_FAILED)
...
CENTERROR_CATALOG(CENTERROR_COMMAND_FAILED)
...
CENTERROR_CATALOG_DESC(
    ...
    NULL /* FIXME: add help describing valid user IDs */ )
...
CENTERROR_CATALOG(CENTERROR_DOMAINJOIN_FAILED_REG_OPENDIR)
