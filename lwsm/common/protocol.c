...
static LWMsgTypeSpec gGetServiceProcessResSpec[] =
{
    LWMSG_STRUCT_BEGIN(SM_IPC_GET_SERVICE_PROCESS_RES_STRUCT),
    LWMSG_MEMBER_UINT8(SM_IPC_GET_SERVICE_PROCESS_RES_STRUCT, process),
    LWMSG_ATTR_RANGE(LW_SERVICE_PROCESS_STANDALONE, LW_SERVICE_PROCESS_SERVICE_MANAGER),
    LWMSG_MEMBER_INT32(SM_IPC_GET_SERVICE_PROCESS_RES_STRUCT, pid),
    LWMSG_STRUCT_END,
    LWMSG_TYPE_END
};
...
static LWMsgProtocolSpec gIpcSpec[] =
{
    ...
    LWMSG_MESSAGE(SM_IPC_GET_SERVICE_PROCESS_REQ, gExistingHandleSpec),
    LWMSG_MESSAGE(SM_IPC_GET_SERVICE_PROCESS_RES, gGetServiceProcessResSpec),
    LWMSG_PROTOCOL_END,
};
