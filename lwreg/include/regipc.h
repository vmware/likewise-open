...
typedef enum __REG_IPC_TAG
{
    ...
    REG_R_ENUM_ROOT_KEYSW_SUCCESS,
    REG_R_ENUM_ROOT_KEYSW_FAILURE,
    REG_Q_CREATE_KEY_EX,
    ...
    REG_R_QUERY_INFO_KEYA_SUCCESS,
    REG_R_QUERY_INFO_KEYA_FAILURE,
    REG_Q_QUERY_INFO_KEYW,
    REG_R_QUERY_INFO_KEYW_SUCCESS,
    REG_R_QUERY_INFO_KEYW_FAILURE,
    REG_Q_SET_KEY_VALUE,
    ...
    REG_Q_SET_VALUEA_EX,
    REG_R_SET_VALUEA_EX_SUCCESS,
    REG_R_SET_VALUEA_EX_FAILURE,
    REG_Q_SET_VALUEW_EX,
    REG_R_SET_VALUEW_EX_SUCCESS,
    REG_R_SET_VALUEW_EX_FAILURE
} REG_IPC_TAG;
