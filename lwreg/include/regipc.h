...
typedef enum __REG_IPC_TAG
{
    ...
    REG_Q_CLOSE_KEY,
    REG_R_CLOSE_KEY_SUCCESS,
    REG_R_CLOSE_KEY_FAILURE,
    REG_Q_DELETE_KEY,
    REG_R_DELETE_KEY_SUCCESS,
    REG_R_DELETE_KEY_FAILURE,
    REG_Q_DELETE_KEY_VALUE,
    REG_R_DELETE_KEY_VALUE_SUCCESS,
    REG_R_DELETE_KEY_VALUE_FAILURE,
    REG_Q_DELETE_TREE,
    REG_R_DELETE_TREE_SUCCESS,
    REG_R_DELETE_TREE_FAILURE,
    REG_Q_DELETE_VALUE,
    ...
    REG_Q_ENUM_VALUE,
    REG_R_ENUM_VALUE_SUCCESS,
    REG_R_ENUM_VALUE_FAILURE,
    REG_Q_ENUM_VALUEA,
    REG_R_ENUM_VALUEA_SUCCESS,
    REG_R_ENUM_VALUEA_FAILURE,
    REG_Q_ENUM_VALUEW,
    REG_R_ENUM_VALUEW_SUCCESS,
    REG_R_ENUM_VALUEW_FAILURE,
    REG_Q_GET_VALUE,
    REG_R_GET_VALUE_SUCCESS,
    REG_R_GET_VALUE_FAILURE,
    REG_Q_GET_VALUEA,
    REG_R_GET_VALUEA_SUCCESS,
    REG_R_GET_VALUEA_FAILURE,
    REG_Q_GET_VALUEW,
    ...
    REG_Q_QUERY_INFO_KEY,
    REG_R_QUERY_INFO_KEY_SUCCESS,
    REG_R_QUERY_INFO_KEY_FAILURE,
    REG_Q_QUERY_VALUE_EX,
    REG_R_QUERY_VALUE_EX_SUCCESS,
    REG_R_QUERY_VALUE_EX_FAILURE,
    REG_Q_QUERY_VALUEA_EX,
    REG_R_QUERY_VALUEA_EX_SUCCESS,
    REG_R_QUERY_VALUEA_EX_FAILURE,
    REG_Q_QUERY_VALUEW_EX,
    REG_R_QUERY_VALUEW_EX_SUCCESS,
    REG_R_QUERY_VALUEW_EX_FAILURE,
    REG_Q_SET_KEY_VALUE,
    REG_R_SET_KEY_VALUE_SUCCESS,
    REG_R_SET_KEY_VALUE_FAILURE,
    REG_Q_SET_VALUE_EX,
    REG_R_SET_VALUE_EX_SUCCESS,
    REG_R_SET_VALUE_EX_FAILURE
} REG_IPC_TAG;
