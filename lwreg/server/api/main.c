...
static LWMsgDispatchSpec gMessageHandlers[] =
{
    ...
    LWMSG_DISPATCH_BLOCK(REG_Q_GET_VALUE, RegSrvIpcGetValueA),
    LWMSG_DISPATCH_BLOCK(REG_Q_GET_VALUE, RegSrvIpcGetValueW),
    LWMSG_DISPATCH_BLOCK(REG_Q_OPEN_KEY_EX, RegSrvIpcOpenKeyEx),
    ...
    LWMSG_DISPATCH_BLOCK(REG_Q_QUERY_VALUE_EX, RegSrvIpcQueryValueEx),
    LWMSG_DISPATCH_BLOCK(REG_Q_SET_VALUE_EX, RegSrvIpcSetValueEx),
    LWMSG_DISPATCH_END
};
