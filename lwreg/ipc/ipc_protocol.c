...
static LWMsgProtocolSpec gRegIPCSpec[] =
{
    ...
    LWMSG_MESSAGE(REG_Q_SET_VALUE_EX, gRegSetValueExSpec),
    LWMSG_MESSAGE(REG_R_SET_VALUE_EX_SUCCESS, NULL),
    LWMSG_MESSAGE(REG_R_SET_VALUE_EX_FAILURE, gRegIPCErrorSpec),
    LWMSG_MESSAGE(REG_Q_GET_VALUE, gRegGetValueSpec),
    LWMSG_MESSAGE(REG_R_GET_VALUE_SUCCESS, gRegGetValueRespSpec),
    LWMSG_MESSAGE(REG_R_GET_VALUE_FAILURE, gRegIPCErrorSpec),
    ...
    LWMSG_MESSAGE(REG_Q_QUERY_VALUE_EX, gRegGetValueSpec),
    LWMSG_MESSAGE(REG_R_QUERY_VALUE_EX_SUCCESS, gRegGetValueRespSpec),
    LWMSG_MESSAGE(REG_R_QUERY_VALUE_EX_FAILURE, gRegIPCErrorSpec),
    ...
    LWMSG_MESSAGE(REG_Q_ENUM_VALUE, gRegEnumValueSpec),
    LWMSG_MESSAGE(REG_R_ENUM_VALUE_SUCCESS, gRegEnumValueRespSpec),
    LWMSG_MESSAGE(REG_R_ENUM_VALUE_FAILURE, gRegIPCErrorSpec),
