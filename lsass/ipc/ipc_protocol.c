...
static LWMsgTypeSpec gLsaStatusSpec[] =
{
    ...
    LWMSG_MEMBER_UINT32(LSASTATUS, version),
...
static LWMsgTypeSpec gLsaAuthUserInfoSpec[] =
{
    ...
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszAccount),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszUserPrincipalName),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszFullName),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszDomain),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszDnsDomain),

    LWMSG_MEMBER_UINT32(LSA_AUTH_USER_INFO, dwAcctFlags),
    LWMSG_MEMBER_TYPESPEC(LSA_AUTH_USER_INFO, dbSessionKey, gLsaIPCDataBlobSpec),
    LWMSG_MEMBER_TYPESPEC(LSA_AUTH_USER_INFO, dbLmSessionKey, gLsaIPCDataBlobSpec),
    ...
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszLogonServer),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszLogonScript),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszProfilePath),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszHomeDirectory),
    LWMSG_MEMBER_PSTR(LSA_AUTH_USER_INFO, pcszHomeDrive),
