...
static LWMsgTypeSpec gLsaOctetStreamSpec[] =
{
    LWMSG_STRUCT_BEGIN(LSA_OCTET_STREAM),
    LWMSG_MEMBER_UINT32(LSA_OCTET_STREAM, ulNumBytes),
    LWMSG_MEMBER_POINTER_BEGIN(LSA_OCTET_STREAM, pBytes),
    LWMSG_UINT8(BYTE),
    LWMSG_POINTER_END,
    LWMSG_ATTR_LENGTH_MEMBER(LSA_OCTET_STREAM, ulNumBytes),
    LWMSG_TYPE_END
};

static LWMsgTypeSpec gLsaAttributeValueSpec[] =
{
    LWMSG_STRUCT_BEGIN(LSA_ATTRIBUTE_VALUE),
    LWMSG_MEMBER_UINT32(LSA_ATTRIBUTE_VALUE, attrValueType),
    LWMSG_MEMBER_UNION_BEGIN(LSA_ATTRIBUTE_VALUE, data),
    LWMSG_MEMBER_UINT32(union __LSA_ATTR_VALUE_DATA, ulValue),
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_INTEGER),
    LWMSG_MEMBER_INT64(union __LSA_ATTR_VALUE_DATA, llValue),
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_LARGE_INTEGER),
    LWMSG_MEMBER_PWSTR(union __LSA_ATTR_VALUE_DATA, pwszStringValue),
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_UNICODE_STRING),
    LWMSG_MEMBER_PSTR(union __LSA_ATTR_VALUE_DATA, pszStringValue),
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_ANSI_STRING),
    LWMSG_MEMBER_UINT8(union __LSA_ATTR_VALUE_DATA, bBooleanValue),
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_BOOLEAN),
    LWMSG_MEMBER_POINTER_BEGIN(union __LSA_ATTR_VALUE_DATA, pOctetStream),
    LWMSG_POINTER_BEGIN,
    LWMSG_TYPESPEC(gLsaOctetStreamSpec),
    LWMSG_POINTER_END,
    LWMSG_POINTER_END,
    LWMSG_ATTR_TAG(LSA_ATTRIBUTE_VALUE_TYPE_OCTET_STREAM),
    LWMSG_UNION_END,
    LWMSG_ATTR_DISCRIM(LSA_ATTRIBUTE_VALUE, attrValueType),
    LWMSG_STRUCT_END,
    LWMSG_TYPE_END
};

static LWMsgTypeSpec gLsaAttributeSpec[] =
{
    LWMSG_STRUCT_BEGIN(LSA_ATTRIBUTE),
    LWMSG_MEMBER_UINT32(LSA_ATTRIBUTE, attrType),

    LWMSG_MEMBER_UINT32(LSA_ATTRIBUTE, ulNumValues),
    LWMSG_MEMBER_POINTER_BEGIN(LSA_ATTRIBUTE, pValues),
    LWMSG_TYPESPEC(gLsaAttributeValueSpec),
    LWMSG_POINTER_END,
    LWMSG_ATTR_LENGTH_MEMBER(LSA_ATTRIBUTE, ulNumValues),
    LWMSG_STRUCT_END,
    LWMSG_TYPE_END
};
