...
#define NETLOGON_NEG_128BIT                      0x00004000  /* Strong Key */
...
#define NETLOGON_NEG_AES_SHA2_SUPPORT            0x00400000
#define NETLOGON_NEG_AES_SUPPORT                 0x01000000
...
[switch_type(UINT32)]
#endif
union _netr_capabilities {
#ifdef _DCE_IDL_
   [case(1)]
#endif
   ULONG server_capabilities;
} NetrCapabilities;
