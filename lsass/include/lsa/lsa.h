...
typedef enum
{
    LSA_ATTRIBUTE_VALUE_TYPE_UNKNOWN = 0,
    LSA_ATTRIBUTE_VALUE_TYPE_INTEGER,
    LSA_ATTRIBUTE_VALUE_TYPE_LARGE_INTEGER,
...
typedef enum
{
    LSA_ATTRIBUTE_TYPE_UNKNOWN = 0,
    LSA_ATTRIBUTE_TYPE_UID,
    LSA_ATTRIBUTE_TYPE_GID,
    LSA_ATTRIBUTE_TYPE_USER_PRINCIPAL_NAME,
    LSA_ATTRIBUTE_TYPE_DISTINGUISHED_NAME,
    LSA_ATTRIBUTE_TYPE_PRIMARY_GROUP,
    LSA_ATTRIBUTE_TYPE_NAME,
    LSA_ATTRIBUTE_TYPE_FULL_NAME,
    LSA_ATTRIBUTE_TYPE_DESCRIPTION,
    LSA_ATTRIBUTE_TYPE_SID,
    LSA_ATTRIBUTE_TYPE_PASSWORD,
    LSA_ATTRIBUTE_TYPE_GECOS,
    LSA_ATTRIBUTE_TYPE_LOGIN_SHELL,
    LSA_ATTRIBUTE_TYPE_HOME_DIRECTORY,
    LSA_ATTRIBUTE_TYPE_GROUP_MEMBERS,
    LSA_ATTRIBUTE_TYPE_USER_INFO_FLAGS,
    LSA_ATTRIBUTE_TYPE_ACCOUNT_EXPIRY,
    LSA_ATTRIBUTE_TYPE_PASSWORD_CHANGE_TIME,
...
typedef struct __LSA_ATTRIBUTE
{
    LSA_ATTRIBUTE_TYPE   attrType;

    ULONG                ulNumValues;
    PLSA_ATTRIBUTE_VALUE pValues;

} LSA_ATTRIBUTE, *PLSA_ATTRIBUTE;
