...
error:
    ...
    LSA_LOG_PAM_DEBUG("pam_sm_open_session failed [Error: %d]", dwError);
...
error:
    ...
    LSA_LOG_PAM_DEBUG("Error: Failed to set MOTD. [Error code: %d]", dwError);
...
error:
    ...
    LSA_LOG_PAM_DEBUG("pam_sm_close_session error [code:%d]", dwError);
