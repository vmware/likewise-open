...
} __attribute__((__packed__)) NTLM_OS_VERSION, *PNTLM_OS_VERSION;
...
typedef struct _NTLM_NEGOTIATE_MESSAGE_V1
{
    ...
    DWORD MessageType;
    DWORD NtlmFlags;
} __attribute__((__packed__))  NTLM_NEGOTIATE_MESSAGE_V1,
                             *PNTLM_NEGOTIATE_MESSAGE_V1;
...
} __attribute__((__packed__))  NTLM_NEGOTIATE_MESSAGE_V2,
							 *PNTLM_NEGOTIATE_MESSAGE_V2;
...
typedef struct _NTLM_NEGOTIATE_MESSAGE_V3
{
    ...
    // Optional Data
} __attribute__((__packed__))  NTLM_NEGOTIATE_MESSAGE_V3,
                             *PNTLM_NEGOTIATE_MESSAGE_V3;
...
typedef struct _NTLM_CHALLENGE_MESSAGE
{
    ...
    // Optional Data
} __attribute__((__packed__)) NTLM_CHALLENGE_MESSAGE,
                            *PNTLM_CHALLENGE_MESSAGE;
...
typedef struct _NTLM_RESPONSE_MESSAGE_V1
{
    ...
    // Optional Data
} __attribute__((__packed__)) NTLM_RESPONSE_MESSAGE_V1,
                            *PNTLM_RESPONSE_MESSAGE_V1;
...
typedef struct _NTLM_RESPONSE_MESSAGE_V2
{
    ...
    DWORD Flags;
    // Optional Data
} __attribute__((__packed__)) NTLM_RESPONSE_MESSAGE_V2,
                            *PNTLM_RESPONSE_MESSAGE_V2;
...
typedef struct _NTLM_RESPONSE_MESSAGE_V3
{
    ...
    NTLM_OS_VERSION Version;
    // Optional Data
} __attribute__((__packed__)) NTLM_RESPONSE_MESSAGE_V3,
                            *PNTLM_RESPONSE_MESSAGE_V3;
...
typedef struct _NTLM_BLOB
{
    ...
    // DWORD Reserved3
} __attribute__((__packed__)) NTLM_BLOB, *PNTLM_BLOB;
...
typedef struct _NTLM_TARGET_INFO_BLOCK
{
    ...
    SHORT sLength;
    //BYTE  Contents[0];
} __attribute__((__packed__)) NTLM_TARGET_INFO_BLOCK,
                            *PNTLM_TARGET_INFO_BLOCK;
