    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_1_BY_NAME,
                               pszUserName);
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_GROUPS_0_BY_UID,
                               uid);

    dwError = DirectorySearch(pDbHandle,
                                pszQuery,
                                &ppszResult,
                                &nRows,
                                &nCols,
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_GROUPS_1_BY_UID,
                               uid);
    ...
    for (iGroup = 0; iGroup < dwNumGroupsFound; iGroup++)
    {
        ...
        nCols = 0;
        nExpectedCols = 1;
        pszQuery = DirectoryMPrintf(DB_QUERY_FIND_GROUP_MEMBERS_BY_GID,
                                   pGroupInfo->gid);
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_0_BY_UID,
                               uid);
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_1_BY_UID,
                               uid);
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_FIND_USER_2_BY_UID,
                               uid);
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(pszDbStatement,
                               dwHashVal_1,
                               dwHashVal_2,
                               dwHashVal_3,
                               dwHashVal_4,
    ...
    )
{
    ...
    pszQuery = DirectoryMPrintf(DB_QUERY_INSERT_USER,
                               pUser->pszName,
                               pUser->pszPasswd,
                               pUser->uid,
                               pUser->gid,
