...
{
    PLSASRV_PRIVILEGE_GLOBALS pGlobals = &gLsaPrivilegeGlobals;
    BOOLEAN LockedPrivileges = FALSE;
    BOOLEAN LockedAccounts = FALSE;

    LSASRV_PRIVS_WRLOCK_RWLOCK(LockedPrivileges, &pGlobals->privilegesRwLock);
    LSASRV_PRIVS_WRLOCK_RWLOCK(LockedAccounts, &pGlobals->accountsRwLock);
