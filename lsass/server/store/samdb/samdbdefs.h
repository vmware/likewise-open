...
#define SAMDB_MAX_PWD_AGE_MINIMUM SAMDB_SECONDS_IN_DAY
#define SAMDB_MAX_PWD_AGE_DEFAULT (30 * SAMDB_SECONDS_IN_DAY)
#define SAMDB_MAX_PWD_AGE_MAXIMUM (180 * SAMDB_SECONDS_IN_DAY)

#define SAMDB_PASSWD_PROMPT_TIME_MINIMUM SAMDB_SECONDS_IN_HOUR
#define SAMDB_PASSWD_PROMPT_TIME_DEFAULT (14 * SAMDB_SECONDS_IN_DAY)
#define SAMDB_PASSWD_PROMPT_TIME_MAXIMUM (30 * SAMDB_SECONDS_IN_DAY)
