...
typedef DWORD (*PFNLSA_MESSAGE_HANDLER)(
                    HANDLE hConnection,
...
typedef struct __LSAMESSAGEHANDLER {

    LsaMessageType         msgType;
    LsaMessageSender       messageSender;
    PFNLSA_MESSAGE_HANDLER pfnHandler;

} LSAMESSAGEHANDLER, *PLSAMESSAGEHANDLER;
