...
#if defined(_WIN32) && !defined(_WIN32_DCELIB_INTERNAL)
_declspec( dllimport ) ndr_boolean rpc_ss_client_is_set_up;
_declspec( dllimport ) ndr_boolean rpc_ss_server_is_set_up;
_declspec( dllimport ) ndr_boolean rpc_ss_allocate_is_set_up;
_declspec( dllimport ) ndr_boolean rpc_ss_context_is_set_up;
#else
...
#if 1
/* TBD Adam: Is this needed??? */
extern void rpc__internal_ss_init_server_once(void);
#endif

#ifdef _WIN32_DCELIB_INTERNAL
#define RPC_SS_INIT_SERVER \
  rpc__internal_ss_init_server_once();
#else
#define RPC_SS_INIT_SERVER \
