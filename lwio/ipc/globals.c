...
LWMsgTypeSpec gSecurityTokenRepSpec[] =
{
    ...
    LWMSG_MEMBER_STRUCT_BEGIN(union _LW_IO_ACCESS_TOKEN_U, krb5Ccache),
    LWMSG_MEMBER_PWSTR(struct _LW_IO_ACCESS_TOKEN_KRB5_CCACHE, pwszPrincipal),
    LWMSG_MEMBER_PWSTR(struct _LW_IO_ACCESS_TOKEN_KRB5_CCACHE, pwszCachePath),
    LWMSG_STRUCT_END,
    LWMSG_ATTR_TAG(IO_ACCESS_TOKEN_TYPE_KRB5_CCACHE),
    /* Union arm -- krb5 tgt */
    LWMSG_MEMBER_STRUCT_BEGIN(union _LW_IO_ACCESS_TOKEN_U, krb5Tgt),
    LWMSG_MEMBER_PWSTR(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, pwszClientPrincipal),
    LWMSG_MEMBER_PWSTR(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, pwszServerPrincipal),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, authTime),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, startTime),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, endTime),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, renewTillTime),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, keyType),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, ulKeySize),
    LWMSG_MEMBER_POINTER(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, pKeyData, LWMSG_UINT8(BYTE)),
    LWMSG_ATTR_LENGTH_MEMBER(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, ulKeySize),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, tgtFlags),
    LWMSG_MEMBER_UINT32(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, ulTgtSize),
    LWMSG_MEMBER_POINTER(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, pTgtData, LWMSG_UINT8(BYTE)),
    LWMSG_ATTR_LENGTH_MEMBER(struct _LW_IO_ACCESS_TOKEN_KRB5_TGT, ulTgtSize),
    LWMSG_STRUCT_END,
    LWMSG_ATTR_TAG(IO_ACCESS_TOKEN_TYPE_KRB5_TGT),
    /* End union */
    LWMSG_UNION_END,
