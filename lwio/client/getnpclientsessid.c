 ...
 *
 *        GetNamedPipeClientSessionId API
 *
    ...
    )
{
    ...
    switch (replyType)
    {
        case SMB_GET_CLIENT_SESSION_ID_SUCCESS:

            break;

        case SMB_GET_CLIENT_SESSION_ID_FAILED:
    ...
    *pdwClientSessionId = pNPResponse->dwId;
