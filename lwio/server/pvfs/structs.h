...
typedef ULONG PVFS_FILE_NAME_OPTIONS, *PPVFS_FILE_NAME_OPTIONS;

#define PVFS_FILE_NAME_OPTION_CASE_SENSITIVE       0x00000001
#define PVFS_FILE_NAME_OPTION_POSIX                0x00000002
#define PVFS_FILE_NAME_OPTION_DEFINED_STREAM_TYPE  0x00000004
...
typedef struct _PVFS_PENDING_SET_FILE_RENAME
{
    PPVFS_IRP_CONTEXT pIrpContext;
    PPVFS_CCB pCcb;
    PPVFS_FILE_NAME newResolvedFileName;

} PVFS_PENDING_SET_FILE_RENAME, *PPVFS_PENDING_SET_FILE_RENAME;

typedef struct _PVFS_PENDING_SET_FILE_DISPOSITION
{
    PPVFS_IRP_CONTEXT pIrpContext;
    PPVFS_CCB pCcb;

} PVFS_PENDING_SET_FILE_DISPOSITION, *PPVFS_PENDING_SET_FILE_DISPOSITION;


typedef struct _PVFS_PENDING_OPLOCK_BREAK_NOTIFY
{
    PPVFS_CCB pCcb;

} PVFS_PENDING_OPLOCK_BREAK_NOTIFY, *PPVFS_PENDING_OPLOCK_BREAK_NOTIFY;
