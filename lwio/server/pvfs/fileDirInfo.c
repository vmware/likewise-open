    ...
    )
{
    ...
    case PVFS_QUERY:
        ntError = PvfsQueryFileDirInfo(pIrpContext);
        break;
...
static NTSTATUS
FillFileDirInfoStatic(
    PFILE_DIRECTORY_INFORMATION pFileInfo,
    PPVFS_STAT pStat
    )
{
    NTSTATUS ntError = STATUS_UNSUCCESSFUL;
...
{
    NTSTATUS ntError = STATUS_UNSUCCESSFUL;
    PFILE_DIRECTORY_INFORMATION pFileInfo = (PFILE_DIRECTORY_INFORMATION)pBuffer;
    ...
    ntError = FillFileDirInfoStatic(pFileInfo, &pEntry->Stat);
    BAIL_ON_NT_STATUS(ntError);
    ...
    )
{
    ...
    PPVFS_CCB pCcb = NULL;
    PFILE_DIRECTORY_INFORMATION pFileInfo = NULL;
    PFILE_DIRECTORY_INFORMATION pPrevFileInfo = NULL;
    ...
    pFileInfo = (PFILE_DIRECTORY_INFORMATION)Args.FileInformation;
    ...
    while (((dwBufLen - dwOffset) > sizeof(FILE_DIRECTORY_INFORMATION)) &&
