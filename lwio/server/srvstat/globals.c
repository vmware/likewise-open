...
LWIO_SRV_STAT_PROVIDER_FUNCTION_TABLE gSrvStatFunctionTable =
{
    ...
    .pfnSessionCreated       = &LwioSrvStatSessionCreated,
    .pfnTreeCreated          = &LwioSrvStatTreeCreated,
    .pfnFileCreated          = &LwioSrvStatFileCreated,
    .pfnFileClosed           = &LwioSrvStatFileClosed,
    .pfnTreeClosed           = &LwioSrvStatTreeClosed,
    .pfnSessionClosed        = &LwioSrvStatSessionClosed,
