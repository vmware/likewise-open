...
typedef struct _LWIO_SRV_SELECT_TRANSPORT_CONFIG
{
    ULONG   ulNumReaders;
    BOOLEAN bEnableSigning;
    BOOLEAN bRequireSigning;

} LWIO_SRV_SELECT_TRANSPORT_CONFIG, *PLWIO_SRV_SELECT_TRANSPORT_CONFIG;
...
typedef struct _LWIO_SRV_SELECT_TRANSPORT_GLOBALS
{
    ...
    LWIO_SRV_SELECT_TRANSPORT_CONFIG config;
