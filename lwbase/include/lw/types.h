...
typedef struct _LW_RPC_UNICODE_STRING {
    LW_USHORT Length;
    LW_USHORT MaximumLength;
#ifdef _DCE_IDL_
    [size_is(MaximumLength/2),length_is(Length/2)]
#endif
    LW_PWCHAR Buffer;
} LW_RPC_UNICODE_STRING, *LW_RPC_PUNICODE_STRING;
...
typedef LW_RPC_UNICODE_STRING RPC_UNICODE_STRING;
typedef LW_RPC_PUNICODE_STRING RPC_PUNICODE_STRING;
