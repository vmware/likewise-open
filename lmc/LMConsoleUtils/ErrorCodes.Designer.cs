    ...
    public class ErrorCodes
    {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager
        {
            get
            {
                ...
                {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("Likewise.LMC.LMConsoleUtils.ErrorCodes", typeof(ErrorCodes).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// </summary>
        public static string WIN32String(int code)
        {
            string result = "";
            try
            {
                result = ResourceManager.GetString(String.Format("WIN32_ERROR_CODE_{0}", code));
            }
            catch (Exception)
            {
                result = String.Format("Exception generating in parsing WIN32 Error: {0}", code);
            }

            if (String.IsNullOrEmpty(result))
            {
                result = String.Format("Unknown WIN32 Error: {0}", code);
            }
        ...
        ///   Looks up a localized string similar to &quot;The operation completed successfully. &quot;.
        /// </summary>
        public static string LDAPString(int code)
        {
            string result = "";

            try
            {
                result = ResourceManager.GetString(String.Format("LDAP_ERROR_CODE_0x{0:x}", code));
            }
            catch (Exception)
            {
                result = String.Format("Exception generated in parsing LDAP Error: 0x{0:x}", code);
            }

            if (String.IsNullOrEmpty(result))
            {
                result = String.Format("Unknown LDAP Error: 0x{0:x}", code);
            }
