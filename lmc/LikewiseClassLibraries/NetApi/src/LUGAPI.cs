...
namespace Likewise.LMC.NETAPI
{
    public class LUGAPI
    {
        ...
        // This doesn't appear to exist in the windows netapi32.dll... are we defining
        // it ourselves in a different file?
        [DllImport(netAPIDllPath)]
            ...
            )
        {
            ...
            try
            {
                ...
                result = (uint)NetLocalGroupSetInfo(servername, null, 1, bufptr, IntPtr.Zero);
            }
            catch (Exception e)
            {
            ...
            )
        {
            ...
            try
            {
                ...
                result = (uint)NetUserSetInfo(servername, null, 1007, bufptr1007, IntPtr.Zero);
            }
            catch (Exception e)
            {
            ...
            )
        {
            ...
            try
            {
                if (!NetApiInitCalled)
                {
                    bool retvalue = NetInitMemory(null, servername);
