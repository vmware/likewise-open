...
{
    public class LdapClassType : SchemaType
    {
        #region Class data

        private string _superClassName;
        private string[] _optionalAttributes;
        private string[] _mandatoryAttributes;
        private object _tag;
        ...
        public LdapClassType(
            ...
            : base(cName, attributeSyntax, attrDisplayName , "")
        {
