...
namespace Likewise.LMC.LDAP
{
    ...
    public struct LDAPArguments
    {
        public string basedn;
        public LdapAPI.LDAPSCOPE scope;
        public string filter;
        public string[] search_attrs;
        public bool attrsonly;

        public LDAPWrapper.ldapMsgDelegate ldapMsgCallback;
