...
namespace System.DirectoryServices.ActiveDirectory
{
    public class TrustRelationshipInformation
    {
        ...
        public void Print()
        {
            Console.WriteLine(string.Format("TrustRelation Information is : SourceName is {0} TargetName is {1}", sourcename, targetname));
            Console.WriteLine(string.Format("TrustType is {0} TrustDirection is {1}.", trusttype, trustdirection));
        }
    }
}
